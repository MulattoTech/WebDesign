<?php 
  ...
  /* ========================= Begin Configuration ============================ */
	define("kContactEmail","dylanmellor@yahoo.com");
  /* ========================= End Configuration ============================== */
	...
	<tr>
		<td class="main" valign="top">
          ...
          <p align="center" class="style2"><BR>
            Thank You, We will get back to you as soon as we can </p>
          <p><span class="style2">This is the information you submitted:</span><br>
			          <br>
...
<span class="styletext">
<span class="style9"><font face="arial, helvetica, sans-serif" size="2"><b>Please fill out the fields below, and we'll contact you with the information you request...</b></font> </span> </span></span></p>
			...
			<table border="0" width="100%" cellpacing="5" cellpadding="0">
				<tr>
					<td class="form" width="50%">
                      ...
                      <p class="style4"> <font face="arial, helvetica, sans-serif" size="2"><font face="arial, helvetica, sans-serif" size="2">Kind of Service 
