<?php 
  /* ========================= Begin Configuration ============================ */
	define("kContactEmail","mmellor@perma-tron.com");
  /* ========================= End Configuration ============================== */
	...
	<tr>
		<td class="main" valign="top">
          ...
          <p align="center" class="style2"><BR>
            Thank You, Maureen will get back to you as soon as they can </p>
...
-->
  ...
  <strong>Maureen Mellor </strong><BR>
  Accounting Manager </font></span></span></p>
