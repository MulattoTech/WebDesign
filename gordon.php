<?php 
  /* ========================= Begin Configuration ============================ */
	define("kContactEmail","gbutler@perma-tron.com");
  /* ========================= End Configuration ============================== */
	...
	<tr>
		<td class="main" valign="top">
          ...
          <p align="center" class="style2"><BR>
            Thank You, Gordon will get back to you as soon as they can </p>
...
-->
  ...
  <strong>Gordon Butler</strong><BR>
  General Manager </font></span></span></p>
