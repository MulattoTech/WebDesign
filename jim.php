<?php 
  /* ========================= Begin Configuration ============================ */
	define("kContactEmail","jlallathin@perma-tron.com");
  /* ========================= End Configuration ============================== */
	...
	<tr>
		<td class="main" valign="top">
          ...
          <p align="center" class="style2"><BR>
            Thank You, Jim will get back to you as soon as they can </p>
...
-->
  ...
  <strong>Jim Harty </strong><BR>
  Project Coordinator </font></span></span></p>
